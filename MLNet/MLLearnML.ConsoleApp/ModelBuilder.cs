...
using MLLearnML.Model;

namespace MLLearnML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\babyDaxiong\source\repos\MLLearn\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\Users\babyDaxiong\AppData\Local\Temp\MLVSTools\MLLearnML\MLLearnML.Model\MLModel.zip";
